...
class North_India extends StatefulWidget {
  const North_India({super.key});

  @override
  State<North_India> createState() => _North_IndiaState();
}

class _North_IndiaState extends State<North_India> {
            ...
            child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: Text("North Indian ",style: TextStyle(fontWeight: FontWeight.w600,fontSize: 25,color: Colors.white54)),
                )
              ],
            ),
          ),
