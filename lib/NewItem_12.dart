...
class New_Item_12 extends StatefulWidget {
  const New_Item_12({super.key});

  @override
  State<New_Item_12> createState() => _New_Item_12State();
}

class _New_Item_12State extends State<New_Item_12> {
            ...
            child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: Text("New Item_12",style: TextStyle(fontWeight: FontWeight.w600,fontSize: 25,color: Colors.white54)),
                )
              ],
            ),
          ),
