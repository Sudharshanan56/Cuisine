...
class South_Indian extends StatefulWidget {
  const South_Indian({super.key});

  @override
  State<South_Indian> createState() => _South_IndianState();
}

class _South_IndianState extends State<South_Indian> {
            ...
            child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: Text("South Indian ",style: TextStyle(fontWeight: FontWeight.w600,fontSize: 25,color: Colors.white54)),
                )
              ],
            ),
          ),
                ...
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  return Container(
                    ...
                    width: 390,
                     ...
                     //           ),
                     //         ),
                     //         Text(e["subcategory_title"],style: TextStyle(fontSize: 25,color: Colors.black54),),
                     //       ],
                     //     );
                     //   },
                     // ),
